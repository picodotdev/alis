...
<section id="whaisit" class="section is-medium">
  <div class="container">
    ...
    <div class="content-wrapper">
      <p>
        Arch Linux Install Script (or alis, also known as _The Executable Arch Linux Installation Guide and Wiki_) installs unattended, automated and customized Arch Linux system.
      </p>
      <p>
